...
export const cocktails: Cocktail[] = [
  ...
  },
  {
    ...
    alcoholic: true,
    ingredients: ["60ml Brauner Rum", "60ml Limettensaft", "100ml Sprudelwasser (manuell hinzufügen)"],
    recipe: [
      { ingredientId: "dark-rum", amount: 60 },
  ...
  },
  {
    ...
    ingredients: [
      ...
      "30ml Blue Curacao",
      "180ml Ananassaft",
      "20ml Sahne (manuell hinzufügen)",
      "20ml Cream of Coconut (manuell hinzufügen)",
    ],
    recipe: [
      { ingredientId: "vodka", amount: 60 },
  ...
  },
  {
    ...
    alcoholic: false,
    ingredients: ["30ml Grenadine", "100ml Orangensaft", "100ml Ananassaft", "20ml Limettensaft", "50ml Sodawasser"],
    recipe: [
